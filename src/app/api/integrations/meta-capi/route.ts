...
export async function POST(request: NextRequest) {
  try {
      ...
      data: [
        {
          ...
          user_data: {
            ...
            client_ip_address: body.clientIpAddress || telemetry.ip,
            client_user_agent: body.clientUserAgent || telemetry.userAgent,
    ...
    return NextResponse.json(
      { error: "Failed to send event to Meta CAPI", details: (error as Error).message },
      { status: 500 }
    )
  }
}
